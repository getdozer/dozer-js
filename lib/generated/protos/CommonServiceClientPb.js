...
class CommonGrpcServiceClient {
    ...
    methodDescriptorcount = new grpcWeb.MethodDescriptor('/dozer.common.CommonGrpcService/count', grpcWeb.MethodType.UNARY, protos_common_pb.QueryRequest, protos_common_pb.CountResponse, (request) => {
    ...
    methodDescriptorquery = new grpcWeb.MethodDescriptor('/dozer.common.CommonGrpcService/query', grpcWeb.MethodType.UNARY, protos_common_pb.QueryRequest, protos_common_pb.QueryResponse, (request) => {
        return request.serializeBinary();
    ...
    methodDescriptorOnEvent = new grpcWeb.MethodDescriptor('/dozer.common.CommonGrpcService/OnEvent', grpcWeb.MethodType.SERVER_STREAMING, protos_common_pb.OnEventRequest, protos_types_pb.Operation, (request) => {
        return request.serializeBinary();
    ...
    methodDescriptorgetEndpoints = new grpcWeb.MethodDescriptor('/dozer.common.CommonGrpcService/getEndpoints', grpcWeb.MethodType.UNARY, protos_common_pb.GetEndpointsRequest, protos_common_pb.GetEndpointsResponse, (request) => {
        return request.serializeBinary();
    ...
    methodDescriptorgetFields = new grpcWeb.MethodDescriptor('/dozer.common.CommonGrpcService/getFields', grpcWeb.MethodType.UNARY, protos_common_pb.GetFieldsRequest, protos_common_pb.GetFieldsResponse, (request) => {
        return request.serializeBinary();
...
//# sourceMappingURL=CommonServiceClientPb.js.map