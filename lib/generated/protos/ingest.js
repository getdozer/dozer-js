...
exports.IngestRequest = {
    ...
    create(base) {
        return exports.IngestRequest.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseIngestRequest();
...
exports.IngestResponse = {
    ...
    create(base) {
        return exports.IngestResponse.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseIngestResponse();
        message.seqNo = object.seqNo ?? 0;
...
exports.IngestArrowRequest = {
    ...
    create(base) {
        return exports.IngestArrowRequest.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseIngestArrowRequest();
        message.schemaName = object.schemaName ?? "";
...
exports.IngestArrowRequest_MetadataEntry = {
    ...
    create(base) {
        return exports.IngestArrowRequest_MetadataEntry.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseIngestArrowRequest_MetadataEntry();
...
exports.IngestMetadata = {
    ...
    create(base) {
        return exports.IngestMetadata.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseIngestMetadata();
        message.typ = object.typ ?? 0;
