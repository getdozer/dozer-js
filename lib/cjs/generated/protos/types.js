...
exports.EventFilter = {
    ...
    decode: function (input, length) {
        ...
        var message = createBaseEventFilter();
    ...
    create: function (base) {
        return exports.EventFilter.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial: function (object) {
        var _a, _b;
        var message = createBaseEventFilter();
        message.type = (_a = object.type) !== null && _a !== void 0 ? _a : 0;
        message.filter = (_b = object.filter) !== null && _b !== void 0 ? _b : undefined;
        return message;
    },
};
...
exports.Record = {
    ...
    fromJSON: function (object) {
        return {
            values: Array.isArray(object === null || object === void 0 ? void 0 : object.values) ? object.values.map(function (e) { return exports.Value.fromJSON(e); }) : [],
    ...
    fromPartial: function (object) {
        var _a, _b;
        var message = createBaseRecord();
        message.values = ((_a = object.values) === null || _a === void 0 ? void 0 : _a.map(function (e) { return exports.Value.fromPartial(e); })) || [];
...
exports.RecordWithId = {
    ...
    decode: function (input, length) {
        var reader = input instanceof minimal_1.default.Reader ? input : new minimal_1.default.Reader(input);
        var end = length === undefined ? reader.len : reader.pos + length;
        var message = createBaseRecordWithId();
        while (reader.pos < end) {
            var tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
exports.SchemaEvent = {
    ...
    decode: function (input, length) {
        var reader = input instanceof minimal_1.default.Reader ? input : new minimal_1.default.Reader(input);
        var end = length === undefined ? reader.len : reader.pos + length;
        var message = createBaseSchemaEvent();
        while (reader.pos < end) {
            var tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
    ...
    fromJSON: function (object) {
        return {
            ...
            fields: Array.isArray(object === null || object === void 0 ? void 0 : object.fields) ? object.fields.map(function (e) { return exports.FieldDefinition.fromJSON(e); }) : [],
        };
    },
    toJSON: function (message) {
        var obj = {};
        ...
        if (message.fields) {
            obj.fields = message.fields.map(function (e) { return e ? exports.FieldDefinition.toJSON(e) : undefined; });
        }
        else {
            obj.fields = [];
        }
    ...
    fromPartial: function (object) {
        ...
        message.version = (_b = object.version) !== null && _b !== void 0 ? _b : 0;
        message.primaryIndex = ((_c = object.primaryIndex) === null || _c === void 0 ? void 0 : _c.map(function (e) { return e; })) || [];
        message.fields = ((_d = object.fields) === null || _d === void 0 ? void 0 : _d.map(function (e) { return exports.FieldDefinition.fromPartial(e); })) || [];
        return message;
    },
};
...
exports.FieldDefinition = {
    ...
    decode: function (input, length) {
        var reader = input instanceof minimal_1.default.Reader ? input : new minimal_1.default.Reader(input);
        var end = length === undefined ? reader.len : reader.pos + length;
        var message = createBaseFieldDefinition();
        while (reader.pos < end) {
            var tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
exports.PointType = {
    ...
    decode: function (input, length) {
        var reader = input instanceof minimal_1.default.Reader ? input : new minimal_1.default.Reader(input);
        var end = length === undefined ? reader.len : reader.pos + length;
        var message = createBasePointType();
        while (reader.pos < end) {
            var tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
exports.DurationType = {
    ...
    decode: function (input, length) {
        var reader = input instanceof minimal_1.default.Reader ? input : new minimal_1.default.Reader(input);
        var end = length === undefined ? reader.len : reader.pos + length;
        var message = createBaseDurationType();
        while (reader.pos < end) {
            var tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
exports.RustDecimal = {
    ...
    decode: function (input, length) {
        var reader = input instanceof minimal_1.default.Reader ? input : new minimal_1.default.Reader(input);
        var end = length === undefined ? reader.len : reader.pos + length;
        var message = createBaseRustDecimal();
        while (reader.pos < end) {
            var tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
    ...
    fromPartial: function (object) {
        var _a, _b, _c, _d, _e;
        var message = createBaseRustDecimal();
        message.scale = (_a = object.scale) !== null && _a !== void 0 ? _a : 0;
        ...
        message.negative = (_e = object.negative) !== null && _e !== void 0 ? _e : false;
        return message;
    },
};
...
exports.Value = {
    encode: function (message, writer) {
        ...
        if (message.jsonValue !== undefined) {
            struct_1.Value.encode(struct_1.Value.wrap(message.jsonValue), writer.uint32(114).fork()).ldelim();
        }
        return writer;
    },
    decode: function (input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 13:
                    ...
                    break;
                case 14:
                    message.jsonValue = struct_1.Value.unwrap(struct_1.Value.decode(reader, reader.uint32()));
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
    ...
    fromJSON: function (object) {
        return {
            ...
            jsonValue: isSet(object === null || object === void 0 ? void 0 : object.jsonValue) ? object.jsonValue : undefined,
        };
    },
    toJSON: function (message) {
        var obj = {};
    ...
    fromPartial: function (object) {
        ...
        message.durationValue = (object.durationValue !== undefined && object.durationValue !== null)
            ...
            : undefined;
        message.jsonValue = (_l = object.jsonValue) !== null && _l !== void 0 ? _l : undefined;
        return message;
    },
};
