...
proto.dozer.ingest.IngestRequest.serializeBinaryToWriter = function (message, writer) {
    ...
    f = message.getOld();
    if (f != null) {
        writer.writeMessage(3, f, types_pb.Record.serializeBinaryToWriter);
    }
    f = message.getNew();
    if (f != null) {
        writer.writeMessage(4, f, types_pb.Record.serializeBinaryToWriter);
    }
    f = message.getSeqNo();
    if (f !== 0) {
...
proto.dozer.ingest.IngestRequest.prototype.getOld = function () {
    return /** @type{?proto.dozer.types.Record} */ (jspb.Message.getWrapperField(this, types_pb.Record, 3));
};
/**
...
proto.dozer.ingest.IngestRequest.prototype.getNew = function () {
    return /** @type{?proto.dozer.types.Record} */ (jspb.Message.getWrapperField(this, types_pb.Record, 4));
};
/**
 * @param {?proto.dozer.types.Record|undefined} value
 * @return {!proto.dozer.ingest.IngestRequest} returns this
...
proto.dozer.ingest.IngestArrowRequest.prototype.getRecords_asB64 = function () {
    return /** @type {string} */ (jspb.Message.bytesAsB64(this.getRecords()));
};
/**
 * optional bytes records = 2;
...
proto.dozer.ingest.IngestArrowRequest.prototype.getRecords_asU8 = function () {
    return /** @type {!Uint8Array} */ (jspb.Message.bytesAsU8(this.getRecords()));
};
/**
...
proto.dozer.ingest.IngestArrowRequest.prototype.getMetadataMap = function (opt_noLazyCreate) {
    return /** @type {!jspb.Map<number,!proto.dozer.ingest.IngestMetadata>} */ (jspb.Message.getMapField(this, 4, opt_noLazyCreate, proto.dozer.ingest.IngestMetadata));
};
/**
