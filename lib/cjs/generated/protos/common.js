...
exports.GetFieldsResponse = {
    ...
    fromJSON(object) {
        return {
            ...
            fields: Array.isArray(object === null || object === void 0 ? void 0 : object.fields) ? object.fields.map((e) => types_1.FieldDefinition.fromJSON(e)) : [],
        };
    },
    toJSON(message) {
        const obj = {};
    ...
    fromPartial(object) {
        ...
        message.fields = ((_b = object.fields) === null || _b === void 0 ? void 0 : _b.map((e) => types_1.FieldDefinition.fromPartial(e))) || [];
        return message;
    },
};
...
exports.QueryResponse = {
    ...
    fromJSON(object) {
        return {
            fields: Array.isArray(object === null || object === void 0 ? void 0 : object.fields) ? object.fields.map((e) => types_1.FieldDefinition.fromJSON(e)) : [],
            records: Array.isArray(object === null || object === void 0 ? void 0 : object.records) ? object.records.map((e) => types_1.RecordWithId.fromJSON(e)) : [],
        };
    },
    toJSON(message) {
        const obj = {};
    ...
    fromPartial(object) {
        var _a, _b;
        const message = createBaseQueryResponse();
        message.fields = ((_a = object.fields) === null || _a === void 0 ? void 0 : _a.map((e) => types_1.FieldDefinition.fromPartial(e))) || [];
        message.records = ((_b = object.records) === null || _b === void 0 ? void 0 : _b.map((e) => types_1.RecordWithId.fromPartial(e))) || [];
        return message;
    },
};
