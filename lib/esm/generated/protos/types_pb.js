...
proto.dozer.types.Operation.serializeBinaryToWriter = function (message, writer) {
    ...
    f = message.getOld();
    if (f != null) {
        writer.writeMessage(2, f, proto.dozer.types.Record.serializeBinaryToWriter);
    }
    f = message.getNew();
    if (f != null) {
        writer.writeMessage(3, f, proto.dozer.types.Record.serializeBinaryToWriter);
    }
...
proto.dozer.types.Operation.prototype.getOld = function () {
    return /** @type{?proto.dozer.types.Record} */ (jspb.Message.getWrapperField(this, proto.dozer.types.Record, 2));
};
/**
...
proto.dozer.types.Operation.prototype.getNew = function () {
    return /** @type{?proto.dozer.types.Record} */ (jspb.Message.getWrapperField(this, proto.dozer.types.Record, 3));
};
/**
 * @param {?proto.dozer.types.Record|undefined} value
 * @return {!proto.dozer.types.Operation} returns this
...
if (jspb.Message.GENERATE_TO_OBJECT) {
    ...
    proto.dozer.types.Record.toObject = function (includeInstance, msg) {
        var f, obj = {
            valuesList: jspb.Message.toObjectList(msg.getValuesList(), proto.dozer.types.Value.toObject, includeInstance),
...
proto.dozer.types.Record.serializeBinaryToWriter = function (message, writer) {
    ...
    if (f.length > 0) {
        writer.writeRepeatedMessage(1, f, proto.dozer.types.Value.serializeBinaryToWriter);
    }
...
proto.dozer.types.Record.prototype.getValuesList = function () {
    return /** @type{!Array<!proto.dozer.types.Value>} */ (jspb.Message.getRepeatedWrapperField(this, proto.dozer.types.Value, 1));
};
/**
...
if (jspb.Message.GENERATE_TO_OBJECT) {
    ...
    proto.dozer.types.SchemaEvent.toObject = function (includeInstance, msg) {
        var f, obj = {
            ...
            fieldsList: jspb.Message.toObjectList(msg.getFieldsList(), proto.dozer.types.FieldDefinition.toObject, includeInstance)
        };
        if (includeInstance) {
            obj.$jspbMessageInstance = msg;
        }
...
proto.dozer.types.SchemaEvent.serializeBinaryToWriter = function (message, writer) {
    ...
    if (f.length > 0) {
        writer.writeRepeatedMessage(4, f, proto.dozer.types.FieldDefinition.serializeBinaryToWriter);
    }
};
/**
...
proto.dozer.types.SchemaEvent.prototype.getFieldsList = function () {
    return /** @type{!Array<!proto.dozer.types.FieldDefinition>} */ (jspb.Message.getRepeatedWrapperField(this, proto.dozer.types.FieldDefinition, 4));
};
/**
...
proto.dozer.types.Value.serializeBinaryToWriter = function (message, writer) {
    ...
    if (f != null) {
        writer.writeMessage(9, f, proto.dozer.types.RustDecimal.serializeBinaryToWriter);
    }
    ...
    if (f != null) {
        writer.writeMessage(12, f, proto.dozer.types.PointType.serializeBinaryToWriter);
    }
    f = message.getDurationValue();
    if (f != null) {
        writer.writeMessage(13, f, proto.dozer.types.DurationType.serializeBinaryToWriter);
    }
    f = message.getJsonValue();
    if (f != null) {
        writer.writeMessage(14, f, google_protobuf_struct_pb.Value.serializeBinaryToWriter);
    }
};
/**
...
proto.dozer.types.Value.prototype.getDecimalValue = function () {
    return /** @type{?proto.dozer.types.RustDecimal} */ (jspb.Message.getWrapperField(this, proto.dozer.types.RustDecimal, 9));
};
/**
...
proto.dozer.types.Value.prototype.getPointValue = function () {
    return /** @type{?proto.dozer.types.PointType} */ (jspb.Message.getWrapperField(this, proto.dozer.types.PointType, 12));
};
/**
...
proto.dozer.types.Value.prototype.getDurationValue = function () {
    return /** @type{?proto.dozer.types.DurationType} */ (jspb.Message.getWrapperField(this, proto.dozer.types.DurationType, 13));
};
/**
...
proto.dozer.types.Value.prototype.getJsonValue = function () {
    return /** @type{?proto.google.protobuf.Value} */ (jspb.Message.getWrapperField(this, google_protobuf_struct_pb.Value, 14));
};
/**
