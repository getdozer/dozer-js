...
export const EventFilter = {
    ...
    create(base) {
        return EventFilter.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b;
        const message = createBaseEventFilter();
...
export const Record = {
    ...
    fromJSON(object) {
        return {
            values: Array.isArray(object === null || object === void 0 ? void 0 : object.values) ? object.values.map((e) => Value.fromJSON(e)) : [],
...
export const RecordWithId = {
    ...
    create(base) {
        return RecordWithId.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a;
        const message = createBaseRecordWithId();
...
export const SchemaEvent = {
    ...
    create(base) {
        return SchemaEvent.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b, _c, _d;
        const message = createBaseSchemaEvent();
        ...
        message.fields = ((_d = object.fields) === null || _d === void 0 ? void 0 : _d.map((e) => FieldDefinition.fromPartial(e))) || [];
        return message;
    },
};
...
export const FieldDefinition = {
    ...
    create(base) {
        return FieldDefinition.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b, _c;
        const message = createBaseFieldDefinition();
...
export const PointType = {
    ...
    create(base) {
        return PointType.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b;
        const message = createBasePointType();
...
export const DurationType = {
    ...
    create(base) {
        return DurationType.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b;
        const message = createBaseDurationType();
...
export const RustDecimal = {
    ...
    create(base) {
        return RustDecimal.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b, _c, _d, _e;
        const message = createBaseRustDecimal();
