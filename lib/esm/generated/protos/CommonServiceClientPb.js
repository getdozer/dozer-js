...
export class CommonGrpcServiceClient {
    constructor(hostname, credentials, options) {
        this.methodDescriptorcount = new grpcWeb.MethodDescriptor('/dozer.common.CommonGrpcService/count', grpcWeb.MethodType.UNARY, common_pb.QueryRequest, common_pb.CountResponse, (request) => {
            return request.serializeBinary();
        }, common_pb.CountResponse.deserializeBinary);
        this.methodDescriptorquery = new grpcWeb.MethodDescriptor('/dozer.common.CommonGrpcService/query', grpcWeb.MethodType.UNARY, common_pb.QueryRequest, common_pb.QueryResponse, (request) => {
            return request.serializeBinary();
        }, common_pb.QueryResponse.deserializeBinary);
        this.methodDescriptorOnEvent = new grpcWeb.MethodDescriptor('/dozer.common.CommonGrpcService/OnEvent', grpcWeb.MethodType.SERVER_STREAMING, common_pb.OnEventRequest, types_pb.Operation, (request) => {
            return request.serializeBinary();
        }, types_pb.Operation.deserializeBinary);
        this.methodDescriptorgetEndpoints = new grpcWeb.MethodDescriptor('/dozer.common.CommonGrpcService/getEndpoints', grpcWeb.MethodType.UNARY, common_pb.GetEndpointsRequest, common_pb.GetEndpointsResponse, (request) => {
            return request.serializeBinary();
        }, common_pb.GetEndpointsResponse.deserializeBinary);
        this.methodDescriptorgetFields = new grpcWeb.MethodDescriptor('/dozer.common.CommonGrpcService/getFields', grpcWeb.MethodType.UNARY, common_pb.GetFieldsRequest, common_pb.GetFieldsResponse, (request) => {
            return request.serializeBinary();
