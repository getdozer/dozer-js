...
export const IngestArrowRequest = {
  ...
  create(base?: DeepPartial<IngestArrowRequest>): IngestArrowRequest {
    return IngestArrowRequest.fromPartial(base ?? {});
  },

  fromPartial(object: DeepPartial<IngestArrowRequest>): IngestArrowRequest {
    const message = createBaseIngestArrowRequest();
    message.schemaName = object.schemaName ?? "";
...
export const IngestArrowRequest_MetadataEntry = {
  ...
  create(base?: DeepPartial<IngestArrowRequest_MetadataEntry>): IngestArrowRequest_MetadataEntry {
    return IngestArrowRequest_MetadataEntry.fromPartial(base ?? {});
  },

  fromPartial(object: DeepPartial<IngestArrowRequest_MetadataEntry>): IngestArrowRequest_MetadataEntry {
    const message = createBaseIngestArrowRequest_MetadataEntry();
...
export const IngestMetadata = {
  ...
  create(base?: DeepPartial<IngestMetadata>): IngestMetadata {
    return IngestMetadata.fromPartial(base ?? {});
  },

  fromPartial(object: DeepPartial<IngestMetadata>): IngestMetadata {
    const message = createBaseIngestMetadata();
    message.typ = object.typ ?? 0;
...
export type IngestServiceDefinition = typeof IngestServiceDefinition;
export const IngestServiceDefinition = {
  name: "IngestService",
  fullName: "dozer.ingest.IngestService",
  methods: {
    ingest: {
      name: "ingest",
      requestType: IngestRequest,
      requestStream: false,
      responseType: IngestResponse,
    ...
    ingest_arrow: {
      name: "ingest_arrow",
      requestType: IngestArrowRequest,
      requestStream: false,
      responseType: IngestResponse,
      responseStream: false,
      options: {},
...
export interface IngestServiceImplementation<CallContextExt = {}> {
  ...
  ingest_stream(
    request: AsyncIterable<IngestRequest>,
    context: CallContext & CallContextExt,
  ): Promise<DeepPartial<IngestResponse>>;
  ingest_arrow(
    request: IngestArrowRequest,
    context: CallContext & CallContextExt,
  ): Promise<DeepPartial<IngestResponse>>;
  ingest_arrow_stream(
    request: AsyncIterable<IngestArrowRequest>,
    context: CallContext & CallContextExt,
  ): Promise<DeepPartial<IngestResponse>>;
}
...
export interface IngestServiceClient<CallOptionsExt = {}> {
  ...
  ingest_stream(
    request: AsyncIterable<DeepPartial<IngestRequest>>,
    options?: CallOptions & CallOptionsExt,
  ): Promise<IngestResponse>;
  ingest_arrow(
    request: DeepPartial<IngestArrowRequest>,
    options?: CallOptions & CallOptionsExt,
  ): Promise<IngestResponse>;
  ingest_arrow_stream(
    request: AsyncIterable<DeepPartial<IngestArrowRequest>>,
    options?: CallOptions & CallOptionsExt,
  ): Promise<IngestResponse>;
}
