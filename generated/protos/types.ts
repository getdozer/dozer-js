...
export const RecordWithId = {
  ...
  create(base?: DeepPartial<RecordWithId>): RecordWithId {
    return RecordWithId.fromPartial(base ?? {});
  },

  fromPartial(object: DeepPartial<RecordWithId>): RecordWithId {
    const message = createBaseRecordWithId();
...
export const SchemaEvent = {
  ...
  create(base?: DeepPartial<SchemaEvent>): SchemaEvent {
    return SchemaEvent.fromPartial(base ?? {});
  },

  fromPartial(object: DeepPartial<SchemaEvent>): SchemaEvent {
    const message = createBaseSchemaEvent();
...
export const FieldDefinition = {
  ...
  create(base?: DeepPartial<FieldDefinition>): FieldDefinition {
    return FieldDefinition.fromPartial(base ?? {});
  },

  fromPartial(object: DeepPartial<FieldDefinition>): FieldDefinition {
    const message = createBaseFieldDefinition();
    message.typ = object.typ ?? 0;
...
export const PointType = {
  ...
  create(base?: DeepPartial<PointType>): PointType {
    return PointType.fromPartial(base ?? {});
  },

  fromPartial(object: DeepPartial<PointType>): PointType {
    const message = createBasePointType();
...
export const RustDecimal = {
  ...
  create(base?: DeepPartial<RustDecimal>): RustDecimal {
    return RustDecimal.fromPartial(base ?? {});
  },

  fromPartial(object: DeepPartial<RustDecimal>): RustDecimal {
    const message = createBaseRustDecimal();
